...
def find_alpha_max(p1_c, p1_v, p_data, rho_data, p_data_dm, rho_data_dm):
    ...
    result = opt.minimize_scalar(neg_lambda, bounds=(0.5, 14), method='bounded')
...
###############################################################################
    ...
    mode, s_type, d_type, eos_c, dm_m, p1_c, p1_v, p2_c, p2_v = get_inputs(1, 3, 2, 'soft', 0.7, 'M', 1.0, 'None', None)
