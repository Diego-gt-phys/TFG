...
Temporary code used to test the lambda maximizer function
...
def find_alpha_max(p1_v, p_data, rho_data, p_data_dm, rho_data_dm):
    """
...
alpha_max = find_alpha_max(p1_v, p_data, rho_data, p_data_dm, rho_data_dm)
