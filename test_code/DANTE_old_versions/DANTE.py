...
if mode == 1:
    ...
    if d_type == 3: # Solution to the TOV for 2 fluid
        ...
        plt.gca().set_xticks(np.arange(0, 11.29, 0.2), minor = True)  # Minor x ticks 
        plt.gca().set_yticks(np.arange(0, 1.15, 0.1))  # Major y ticks
        plt.gca().set_yticks(np.arange(0, 1.15, 0.025), minor = True)  # Minor y ticks 
